...
<table>
<tr>
<td width="50%"><img src="docs/screenshots/ide-02-statistics.png" alt="Column statistics"></td>
<td width="50%"><img src="docs/screenshots/ide-03-value.png" alt="A nested value in full"></td>
</tr>
<tr>
<td><img src="docs/screenshots/ide-04-excel.png" alt="An Excel workbook"></td>
<td><img src="docs/screenshots/ide-06-avro.png" alt="An Avro file"></td>
</tr>
</table>

`ide-*.png` are taken in IntelliJ IDEA with the plugin installed; the numbered ones are
rendered headlessly by `ScreenshotsTest` and are there to catch layout regressions.
